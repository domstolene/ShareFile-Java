...
public class SFFreeTrialAccount extends SFAccount {
	...
	public Boolean getIsHipaaBaa() {
		return this.IsHipaaBaa;
	}

	public void setIsHipaaBaa(Boolean ishipaabaa) {
		this.IsHipaaBaa = ishipaabaa;
	}
		/**
		* ID of company creating this free trial
		*/
	...
	public void setExternalId(String externalid) {
		...
		/**
		* Optional parameter used only during Account Creation.
		* Allows the new account to be created as a Tenant
		*/
	public SFTenantAccountCreationParameters getTenantOptions() {
		...
		* Allows the new account to be created as a Tenant
		*/
	public void setTenantOptions(SFTenantAccountCreationParameters tenantoptions) {
