...
public class SFHttpsCaller
{
	...
	public static void setBasicAuth(URLConnection conn,String username,String password)
	{
		...
		String basicAuth = "Basic " + new String(Base64.encodeBase64(combinepass.getBytes(StandardCharsets.ISO_8859_1)));
	...
	private static String getRootQueryParamter(URL url) {
		...
		return URLDecoder.decode(pairs[0].substring(idx + 1), StandardCharsets.UTF_8);
	}
	...
	public static String readResponse(URLConnection conn) throws IOException
	{
		...
		BufferedReader urlstream = new BufferedReader(new InputStreamReader(is, SFKeywords.UTF_8));
		String inputLine;
